...
# Copyright 1996 Matt Wright    Modified
# Created 10/21/95              Last Modified 11/25/95                       #
##############################################################################
# Define Variables

$basedir = "/www/falcon-pro/bbs";
$baseurl = "http://falcon-pro.com/bbs";
$cgi_url = "http://falcon-pro.com/cgi-falcon-pro/wwwboard.pl";
...
$title = "falcon-pro Message Board";
...
sub new_file {
   ...
   print NEWFILE "Name:<br> <input type=text name=\"name\" size=50><br>\n";
   print NEWFILE "E-Mail:<br> <input type=text name=\"email\" size=50><p>\n";
   if ($subject_line == 1) {
      if ($subject_line =~ /^Re:/) {
         print NEWFILE "<input type=hidden name=\"subject\" value=\"$subject\">\n";
         print NEWFILE "Subject:<br> <b>$subject</b><p>\n";
      }
      else {
         print NEWFILE "<input type=hidden name=\"subject\" value=\"Re: $subject\">\n";
         print NEWFILE "Subject:<br> <b>Re: $subject</b><p>\n";
      }
   } 
   elsif ($subject_line == 2) {
      print NEWFILE "Subject:<br> <input type=text name=\"subject\" 
size=50><p>\n";
   }
   else {
      if ($subject =~ /^Re:/) {
         print NEWFILE "Subject:<br> <input type=text name=\"subject\"value=\"$subject\" size=50><p>\n";
      }
      else {
         print NEWFILE "Subject:<br> <input type=text name=\"subject\" value=\"Re: $subject\" size=50><p>\n";
      }
   }
   ...
   print NEWFILE "<p>\n";
   print NEWFILE "Optional Link URL:<br> <input type=text name=\"url\" size=50><br>\n";
   print NEWFILE "Link Title:<br> <input type=text name=\"url_title\" size=48><br>\n";
   print NEWFILE "Optional Image URL:<br> <input type=text name=\"img\" size=49><p>\n";
...
sub return_html {
   ...
   print "<bodybgcolor=\"#ffffff\"><center><h1>Message Added: $subject</h1></center>\n";
   print "The following information was added to the message board:<p><hr size=7 width=75%><p>\n";
   print "<b>Name:</b><br> $name<br>\n";
   print "<b>E-Mail:</b><br> $email<br>\n";
   print "<b>Subject:</b><br> $subject<br>\n";
...
sub rest_of_form {
   ...
   print "Name:<br> <input type=text name=\"name\" value=\"$FORM{'name'}\" size=50><br>\n";
   print "E-Mail:<br> <input type=text name=\"email\" value=\"$FORM{'email'}\" size=50><p>\n";
   if ($subject_line == 1) {
      print "<input type=hidden name=\"subject\" value=\"$FORM{'subject'}\">\n";
      print "Subject: <b>$FORM{'subject'}</b><p>\n";
   } 
   else {
      print "Subject:<br> <input type=text name=\"subject\" value=\"$FORM{'subject'}\" size=50><p>\n";
   }
   print "Message:<br>\n";
   ...
   print "$FORM{'body'}\n";
   print "</textarea><p>\n";
   print "Optional Link URL:<br> <input type=text name=\"url\" value=\"$FORM{'url'}\" size=45><br>\n";
   print "Link Title:<br> <input type=text name=\"url_title\" value=\"$FORM{'url_title'}\" size=50><br>\n";
   print "Optional Image URL:<br> <input type=text name=\"img\" value=\"$FORM{'img'}\" size=45><p>\n";
